...
export class ApiGatewayConstruct extends Construct {
    ...
    Mittels Benennung über den Parameter \textit{id} lässt sich ein solches Construct leichter Debuggen.
...
\section{Endpunkte}
    ...
    In diesem wird die Stage \textit{prod} erstellt.
    ...
    Sie kann mittels Preview oder mittels OpenAPI-Generator in IntelliJ betrachtet werden.
...
\section{Beispiel: attach}
    ...
    Dieser ist in der untenstehenden Grafik\ \ref{gph:attach} nochmals visuell erkenntlich.
